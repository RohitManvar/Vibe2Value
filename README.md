# Vibe2Value — RoCathon Hybrid Search Engine
...
npm run seed      # embeds 186 creators (~2 min on first run, model downloads once)
```
...
| `npm run seed` | Embeds all creators and inserts into DB |
...
Response includes full score breakdown per creator:
```json
{
  "results": [
    {
...
CREATE TABLE creators (
  ...
  projected_score   DOUBLE PRECISION, -- pre-computed 60-100 score from portal
